...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/css/mine.css" type="text/css" rel="stylesheet" />
        <script language="JavaScript" src="${pageContext.request.contextPath}/js/jquery-1.11.3.min.js"></script>
        <script>
        function addtask(){
        	var ret=showModalDialog("${pageContext.request.contextPath}/DS/analyseTrans/AddTask.jsp",window,"dialogHeight:300px;dialogWidth:400spx;status:no;scroll:yes;help:no;status:no;resizable:yes");
  			if(ret){
  				location.reload();
  			}      
        }
        function bydate(){
              var ret=showModalDialog("${pageContext.request.contextPath}/DS/analyseTrans/analyseByDate.jsp",window,"dialogHeight:300px;dialogWidth:600spx;status:no;scroll:yes;help:no;status:no;resizable:yes");  
        }
		$(function(){
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                <span style="float: left;">百货>Trans分析</span>
